...
class WorkdayFailureClass(str, Enum):
    ...
    POST_SUBMIT_ACCOUNT_EXISTS = "post_submit_account_exists"
    POST_SUBMIT_AUTH_REJECTED = "post_submit_auth_rejected"
    POST_SUBMIT_OTHER_OR_UNKNOWN = "post_submit_other_or_unknown"
    ACCOUNT_DISCOVERY_ACCOUNT_EXISTS = "account_discovery_account_exists"
    ACCOUNT_DISCOVERY_RETRY_EXHAUSTED = "account_discovery_retry_exhausted"
